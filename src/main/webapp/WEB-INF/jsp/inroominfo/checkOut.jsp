...
<div style="display: none;margin-top: 20px;" id="exitInRoomInfoDiv">
    <form class="layui-form layui-form-pane" action="" lay-filter="exitInRoomInfoForm" style="margin-left: 50px;">
        ...
        <%--会员的折扣--%>
        <input type="hidden" name="vipRate" value="1" id="vipRate"/>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <%--
                    lay-verify="number|otherPrice"
                    otherPrice: 自定义的验证名称
                    --%>
                        <input type="text" name="otherPrice" lay-verify="number|otherPrice" value="0" autocomplete="off" class="layui-input" placeholder="请输入金额" id="otherPrice">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
