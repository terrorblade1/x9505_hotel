...
<body>
<blockquote class="layui-elem-quote">入住信息添加</blockquote>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" id="vip_num" lay-verify="vip_num" placeholder="请输入会员卡号" autocomplete="off" class="layui-input" disabled>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
