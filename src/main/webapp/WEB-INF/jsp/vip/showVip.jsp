            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="idcard" autocomplete="off" class="layui-input" placeholder="请输入身份证号号">
                    </div>
                </div>
                <div class="layui-inline">
...
<jsp:include page="updateVip.jsp"/>
</body>
<%--引入layui的js文件--%>
...
<script type="text/html" id="vipRateTpl">
    {{#  if(d.vipRate == 0.8){ }}
    <font color="##FF0500">超级会员</font>
    {{#  } else { }}
    <font color="#42F816">普通会员</font>
    {{#  } }}
</script>
<%--性别显示--%>
