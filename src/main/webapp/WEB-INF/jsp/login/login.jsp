...
<body >
	<div class="qiqiu1 qiqiu">
		<img src="http://q6eyfu13z.bkt.clouddn.com/q2.png" />
		<div class="text">韦氏集团</div>
	</div>
	<div class="qiqiu2 qiqiu">
		<img src="http://q6eyfu13z.bkt.clouddn.com/q3.png" />
		<div class="text">韦氏集团</div>
	</div>
	<div class="qiqiu3 qiqiu">
		<img src="http://q6eyfu13z.bkt.clouddn.com/q4.png" />
		<div class="text">韦氏集团</div>
	</div>
	<div class="qiqiu4 qiqiu">
		<img src="http://q6eyfu13z.bkt.clouddn.com/q5.png" />
		<div class="text">韦氏集团</div>
	</div>
	<div class="qiqiu5 qiqiu">
		<img src="http://q6eyfu13z.bkt.clouddn.com/q6.png" />
		<div class="text">韦氏集团</div>
	</div>
	...
	<script type="text/javascript">
		function flushCheckCode(obj) {
		    //拼接当前时间，使每一次的点击访问路径不一样，让其路径改变，方可再次访问
