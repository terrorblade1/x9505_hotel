		...
		<ul class="layui-nav layui-layout-left">
			<c:forEach items="${mapList}" var="map">
				<li class="layui-nav-item">
					<a href="javascript:;">
						<c:if test="${map['firstAuthorityId']==1}">
							<i class="layui-icon">&#xe63c;</i>
						</c:if>
						<c:if test="${map['firstAuthorityId']==2}">
							<i class="layui-icon">&#xe62a;</i>
						</c:if>
						<c:if test="${map['firstAuthorityId']==3}">
							<i class="layui-icon">&#xe770;</i>
						</c:if>
						<c:if test="${map['firstAuthorityId']==4}">
							<i class="layui-icon">&#xe716;</i>
						</c:if>
						<c:if test="${map['firstAuthorityId']==5}">
							<i class="layui-icon">&#xe63c;</i>
						</c:if>
						<c:if test="${map['firstAuthorityId']==6}">
							<i class="layui-icon">&#xe63a;</i>
						</c:if>
							${map['firstAuthorityName']}
					</a>
					<dl class="layui-nav-child" style="padding-left: 15px">
						<c:forEach items="${map['secondAuthorities']}" var="secondAuthority">
							<dd>
			...
			<ul class="layui-nav hp-nav-none">
				<li class="layui-nav-item">
					<a href="javascript:;"  class="hp-user-name">
						<img src="http://q6eyfu13z.bkt.clouddn.com/renwu004.jpg" class="layui-circle-img layui-anim-upbit">
